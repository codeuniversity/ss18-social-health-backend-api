...
RSpec.describe ClustersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new cluster" do

        post :create, params: {cluster: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(cluster_url(Cluster.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new cluster" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the cluster" do
        cluster = Cluster.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the cluster" do
        cluster = Cluster.create! valid_attributes
  ...
  describe "DELETE #destroy" do
    it "destroys the requested cluster" do
      cluster = Cluster.create! valid_attributes
      expect {
        delete :destroy, params: {id: cluster.to_param}, session: valid_session
      }.to change(Cluster, :count).by(-1)
    end
  end
